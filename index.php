          ...
          <div class="header-bottom-overlay">
            <nav>
              <div class="logo-floating-header-container">
                <a href="/">
                  <img
                    class="logo-floating-header"
                    src="./images/logo.png"
                    alt="forêt éclairée par le ciel"
                /></a>
              </div>
              <ul>
                <li class="nav-item"><a href="#cabinet">Notre cabinet</a></li>
                <li class="nav-item"><a href="#accompagnement">Notre accompagnement</a></li>
                <li class="nav-item"><a href="#objectifs">Vos objectifs</a></li>
                <li class="nav-item"><a href="#certification">Nos certifications</a></li>
    ...
    <footer id="contact">
      <div class="footer-overlay">
        <div class="sendEmail">
          ...
          <a href="mailto:contact@heritage-conseil-patrimoine.fr"
